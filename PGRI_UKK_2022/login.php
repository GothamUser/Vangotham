...
if (isset($_POST['pengguna_baru'])) {
    if (empty(file_exists($file))) {
        ...
        fwrite($fh, "");
        fclose($fh);
        $alert="<div class='alert alert-success'>Anda berhasil Mendaftar</div>";
        $_SESSION['nik']=$nik;
        $_SESSION['nama']=$nama;
        echo "<meta http-equiv='refresh', content='2; url=index.php'>";
    }
    else{
        $alert="<div class='alert alert-danger'>Anda gagal Mendaftar</div>";
    }
}
                ...
                <div class="card-body py-5">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-inline btn-a">
                            <button class="btn btn-primary" name="pengguna_baru">Daftar Pengguna Baru</button>
